                ...
                <div className="bg-white w-full sm:max-w-2xl sm:rounded-lg p-6 space-y-6 animate-slide-up">
                    ...
                    <div className="space-y-4 max-h-96 overflow-y-auto">
                        ...
                        <div className="flex items-start p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <input
                                ...
                                disabled
                                className="mt-1 mr-4 w-5 h-5 text-primary-dark cursor-not-allowed"
                            />
                        ...
                        <div className="flex items-start p-4 bg-white rounded-lg border border-gray-200 hover:border-gray-300 cursor-pointer"
                            ...
                            <input
                                ...
                                className="mt-1 mr-4 w-5 h-5 text-primary-dark cursor-pointer"
                            />
                            <div className="flex-1">
                    ...
                    <div className="flex gap-3 justify-end">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-primary-dark text-white font-semibold rounded-lg hover:bg-primary-darker transition"
                        >
                            Save Preferences
                        </button>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                    ...
                    <div className="flex gap-3 flex-wrap">
                        ...
                        <button
                            ...
                            className="px-6 py-2 border border-sky-600 text-primary-dark font-semibold rounded-lg hover:bg-bg-accent transition whitespace-nowrap"
                        >
                            Customize
                        </button>
                        <button
                            onClick={handleAcceptAll}
                            className="px-6 py-2 bg-primary-dark text-white font-semibold rounded-lg hover:bg-primary-darker transition whitespace-nowrap"
                        >
                            Accept All
                        </button>
                    </div>
