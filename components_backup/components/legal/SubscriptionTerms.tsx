    ...
    return (
        <div className="flex-grow p-4 sm:p-6 bg-slate-50 min-h-full">
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8">
                <button
                    onClick={onBack}
                    className="mb-6 text-primary-dark hover:text-primary-darker flex items-center gap-2"
                >
                    <i className="fa fa-arrow-left"></i>
                    Back
                </button>

                <h1 className="text-3xl font-bold text-gray-900 mb-6">Subscription & Billing Terms</h1>
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Pricing & Billing</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Automatic Renewal</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">6. Free Trial</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Payment Methods</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">9. Billing Information</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">10. Subscription Changes</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">11. Suspension for Non-Payment</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">12. Contact & Disputes</h2>
                        <p>
