    ...
    return (
        <div className="flex-grow p-4 sm:p-6 bg-slate-50 min-h-full">
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8">
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-6">Medical & Educational Disclaimer</h1>
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Educational Purpose Only</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Not a Medical Service</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">3. No Real Patient Data</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">4. AI Limitations</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Use of Real Patient Scenarios</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">6. Feedback & Coaching Summaries</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Liability Waiver</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">8. Professional License & Credentials</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">9. Emergency or Crisis Situations</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">10. Regulatory Compliance</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 mb-3">12. Questions or Concerns</h2>
                        <p>
