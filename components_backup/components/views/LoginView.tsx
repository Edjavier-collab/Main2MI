                    ...
                    {isSignUp && (
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white disabled:opacity-50"
                            />
                        </div>
                    )}
                    <div>
                    ...
                    {!isSignUp && (
                        <div className="text-right">
                            <button
                                ...
                                disabled={loading}
                                className="text-sm font-medium text-primary-dark hover:text-primary dark:text-sky-400 dark:hover:text-sky-300 disabled:opacity-50"
                            >
                                Forgot Password?
                            </button>
                        </div>
