    ...
    return (
        <div className="relative cursor-pointer" onClick={onUpgrade}>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/60 rounded-2xl transition-all hover:bg-white/70">
                ...
                <p className="text-primary text-xs mt-1 font-medium">Tap to upgrade</p>
            </div>
        </div>
    );
};
...
const FeedbackSectionCard: React.FC<{ title: string; icon: string; children: React.ReactNode }> = ({ title, icon, children }) => (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <h3 className="text-lg font-bold text-slate-700 mb-3 flex items-center">
            <i className={`fa-solid ${icon} mr-3 text-primary`}></i>
            {title}
        </h3>
                ...
                <div className="w-full max-w-md bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                    ...
                    <div className="mt-8 space-y-3">
                        {tier === UserTier.Free && (
                            <button
                                onClick={onUpgrade}
                                className="w-full flex items-center justify-center gap-3 bg-primary text-white font-bold py-4 rounded-full shadow-md hover:bg-primary-dark transition-transform transform hover:scale-105"
                            >
                        ...
                        {onStartPractice && (
                            <button
                                ...
                                className="w-full bg-primary text-white font-bold py-3 rounded-full hover:bg-primary-dark transition"
                            >
                ...
                <div className="p-4 sm:p-6 max-w-2xl mx-auto">
                    ...
                    <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
                        ...
                        <div className="text-center mt-4">
                            <button
                                onClick={onUpgrade}
                                className="text-primary-dark font-semibold text-sm hover:text-primary-darker transition-colors flex items-center justify-center gap-2 mx-auto"
                            >
                    ...
                    {areasForGrowthContent && (
                        <section className="mb-6">
                            <LockedSection onUpgrade={onUpgrade} lockMessage="Unlock with Premium">
                                <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                                    <h3 className="text-lg font-bold text-slate-700 mb-3 flex items-center">
                                        <i className="fa-solid fa-seedling mr-3 text-primary"></i>
                    ...
                    <footer className="mt-6 space-y-3">
                        ...
                        <button 
                            onClick={onDone} 
                            className="w-full bg-primary-lighter text-primary-dark font-bold py-4 rounded-full hover:bg-sky-200 transition"
                        >
                            Done
                        </button>
                    </footer>
    ...
    return (
        <div className="bg-slate-50">
             <div className="p-4 sm:p-6 max-w-2xl mx-auto">
                ...
                {premiumNextFocus && (
                    <section className="bg-primary-darker text-white rounded-2xl p-6 shadow-lg mb-6 text-center">
                ...
                <footer className="mt-4 pb-4">
                    <button 
                        onClick={onStartPractice}
                        className="w-full bg-primary text-white font-bold py-4 px-6 rounded-full text-lg shadow-lg hover:bg-primary-dark transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-primary-light"
                    >
                        Start a New Practice
                    </button>
                </footer>
