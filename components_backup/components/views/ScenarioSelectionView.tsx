    ...
    return (
        <div ref={containerRef} className="relative">
            <label id={`${id}-label`} className="block text-2xl font-bold text-gray-800 mb-4">
                <i className={`${icon} mr-3 text-primary-dark`}></i>
                {label}
            </label>
            ...
            <button
                ...
                className="w-full p-5 pr-14 text-left text-2xl border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-primary font-medium cursor-pointer transition-all"
                        ...
                        {options.map((option, index) => (
                            <li
                                ...
                                className={`
                                    ...
                                    ${option.value === value 
                                        ? 'bg-bg-accent text-primary-darker font-bold' 
                            ...
                            >
                                {option.value === value && (
                                    <i className="fa-solid fa-check mr-3 text-primary-dark"></i>
                                )}
                                {option.label}
                            </li>
                        ))}
        ...
        <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
            ...
            <main className="max-w-2xl mx-auto">
                ...
                <div className="mt-8 space-y-4">
                     <button
                        onClick={handleStart}
                        className="w-full bg-primary text-white font-bold py-4 px-6 rounded-full text-lg shadow-lg hover:bg-primary-dark transition-transform transform hover:scale-105"
                    >
