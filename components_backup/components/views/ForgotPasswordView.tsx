                ...
                {isSent ? (
                    <div className="text-center animate-slide-fade-in">
                        ...
                        {resendCooldown > 0 ? (
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="mb-4 w-full text-sm text-primary-dark hover:text-primary-darker font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                    ...
                    <form onSubmit={handleSendResetLink} className="w-full text-center">
                        ...
                        <input
                            ...
                            required
                            disabled={loading}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary mb-8 disabled:opacity-50"
                        />
                        <button
                            type="submit"
                            className="w-full bg-primary text-white font-bold py-3 px-6 rounded-full text-lg shadow-md hover:bg-primary-dark transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
