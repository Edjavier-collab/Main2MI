...
const SummarySectionCard: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
        <h2 className="text-xl font-bold text-primary-darker mb-4 flex items-center">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-6">
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                                <div className="flex items-center">
                                    <div className="bg-primary-lighter text-primary-dark rounded-xl p-4 mr-4">
            ...
            <header className="flex items-center justify-between mb-6 pt-2 max-w-4xl mx-auto no-print">
                ...
                {!isLoading && (
                     <button
                        ...
                        disabled={!summary}
                        className="bg-primary text-white font-bold py-2 px-4 rounded-full shadow-md hover:bg-primary-dark transition-transform transform hover:scale-105 disabled:bg-gray-400 disabled:cursor-not-allowed"
                    >
