                        ...
                        <div key={index} className="border-l-4 border-slate-300 pl-4 py-2 my-4 bg-slate-50 rounded-r-lg">
                            {item.lines.map((line: {speaker: string, text: string}, i: number) => (
                                <p key={i} className="mb-1">
                                    <span className={`font-bold ${line.speaker.includes('Patient') ? 'text-rose-600' : 'text-primary-dark'}`}>{line.speaker}: </span>
        ...
        <div className="bg-slate-50 min-h-full flex flex-col p-4">
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary"
                />
            </div>
                    ...
                    return (
                        <div key={category.category}>
                            <button
                                ...
                                className={`w-full text-left font-bold p-3 rounded-lg flex justify-between items-center ${isPremium ? 'cursor-pointer' : 'cursor-default'} bg-primary-lighter text-primary-darker border-l-4 border-primary`}
                            >
                                    ...
                                    {isPremium ? (
                                        ...
                                        <>
                                            ...
                                            {premiumItems.length > 3 && (
                                                <div onClick={onUpgrade} className="mt-2 bg-bg-accent border-2 border-sky-300 border-dashed rounded-lg p-4 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-primary-lighter transition-colors">
                                                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-sky-200 mb-2">
                                                        <i className="fa fa-unlock text-xl text-primary-dark"></i>
                                                    </div>
                                                    <p className="font-bold text-primary-darker">Unlock All Advanced Techniques</p>
                                                </div>
                                            )}
                                        </>
                                    )}
