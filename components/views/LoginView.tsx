        ...
        <Card variant="glass" padding="lg" className={`login-view__card ${animationClass}`}>
          ...
          <form onSubmit={vm.handlers.handleSubmit} className="space-y-4">
            ...
            <div className="text-center">
              ...
              >
                {vm.formState.isSignUp
                  ? <>Already have an account? <span className="font-semibold text-[var(--color-primary)]">Log In</span></>
                  : <>Don't have an account? <span className="font-semibold text-[var(--color-primary)]">Sign Up</span></>}
              </button>
            </div>
          </form>
        </Card>
